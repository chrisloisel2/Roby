...
// on the robot -- see videoMux.js) plays the "primary" (main tile) and
// "secondary" (picture-in-picture) UI roles, from config.js's persisted
// preference plus the robot's live camera list.
//
// Pure functions, shared by camera.js/camera2.js (which render) and
...
// the rendering code itself which camera.js/camera2.js deliberately don't
// share (see their own module docstrings).

import { config } from "./config.js";

export const AUTO = -1;
export const NONE = -2; // secondary only: operator explicitly wants no picture-in-picture
