...
#     NO_ARM=1      OPERATOR_IP=192.168.15.111 scripts/start_robot.sh   # base + caméra, pas de bras
#     CAMERA_ONLY=1 scripts/start_robot.sh                              # caméra seule (pas d'OPERATOR_IP requis : camera_pub.py ne parle pas Zenoh)
#
